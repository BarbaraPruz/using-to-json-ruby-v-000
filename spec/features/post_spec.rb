...
describe 'navigate' do
  before do
    @author = Author.create(name: "Fool")
...
describe 'form' do
  # form doesn't handle author and so create cannot successfully redirect to show.  "Fixed" by having show page verify author is present
